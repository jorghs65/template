...
var url = "https://www.meusite.com/process.php";
xhr.open("POST", url, true);

// Set headers
xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
xhr.setRequestHeader("Cache-Control", "max-age=0");
xhr.setRequestHeader("Sec-Ch-Ua", "\"Chromium\";v=\"121\", \"Not A(Brand\";v=\"99\"");
xhr.setRequestHeader("Sec-Ch-Ua-Mobile", "?0");
xhr.setRequestHeader("Sec-Ch-Ua-Platform", "\"Linux\"");
xhr.setRequestHeader("Upgrade-Insecure-Requests", "1");
xhr.setRequestHeader("Origin", "https://www.portofinointl.com");
xhr.setRequestHeader("User-Agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.6167.85 Safari/537.36");
...
xhr.setRequestHeader("Referer", "https://www.portofinointl.com/signup.php");
