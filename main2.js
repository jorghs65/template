...
$(document).ready(function(){
    ...
    $('html').addClass(' js flexbox canvas canvastext webgl no-touch geolocation postmessage no-websqldatabase indexeddb hashchange history draganddrop websockets rgba hsla multiplebgs backgroundsize borderimage borderradius boxshadow textshadow opacity cssanimations csscolumns cssgradients cssreflections csstransforms csstransforms3d csstransitions fontface generatedcontent video audio localstorage sessionstorage webworkers no-applicationcache svg inlinesvg smil svgclippaths');
...
<ul class="dropdown-menu parent-ul vertical-menu" role="menu" aria-labelledby="dropdownMenu"><li class="list-group-item"><a href="products.php?status=2" style="color:#8C0000; font-size:15px;" class="highlight" id="new-items-tooltip">NEW ITEMS</a></li><li class="list-group-item"><a href="products.php?status=1" style="color:#8C0000; font-size:15px;" class="highlight" id="new-arrivals-tooltip">BACK IN STOCK</a></li><div id="new-items-tooltip-box" class="coming-soon-box" style="display: none; margin-left: 130px; margin-top: -15px; width: 150px; height: 45px;">New Portofino<br>products</div><div id="new-arrivals-tooltip-box" class="coming-soon-box" style="display: none; margin-left: 130px; margin-top: 5px; width: 150px; height: 45px;">New Arrivals<br>of existing products</div><li class="list-group-item"><a href="sale.php?view=grid&amp;status=2" style="color:#8C0000; font-size:15px;" class="highlight">SALE</a></li><li class="list-group-item"><a href="outlet.php?view=grid&amp;status=4" style="margin-bottom:20px;color:#8C0000; font-size:15px;" class="highlight">OUTLET</a></li><li class="list-group-item"><a href="shop_by_item.php" style="margin-top:5px;margin-bottom:2px;color:#8C0000; font-size:15px;" class="highlight">SHOP BY ITEM</a></li>								<li class="dropdown-submenu">
                       ...
                       <!--  <div id="product-hero" class="" style="margin-bottom:10px;">
                        ...
                        <li style="display:none;" class="list-group-item">SHOP BY EVENT</li><li style="display:none;" class="dropdown-submenu"><a href="Baby_Shower" style="text-transform:uppercase;">Baby Shower</a></li><li style="display:none;" class="dropdown-submenu"><a href="Baptism" style="text-transform:uppercase;">Baptism</a></li><li style="display:none;" class="dropdown-submenu"><a href="Craft_Supplies" style="text-transform:uppercase;">Craft Supplies</a></li><li style="display:none;" class="dropdown-submenu"><a href="Decorations" style="text-transform:uppercase;">Decorations</a></li><li style="display:none;" class="dropdown-submenu"><a href="Event_Planning" style="text-transform:uppercase;">Event Planning</a></li><li style="display:none;" class="dropdown-submenu"><a href="First_Communion" style="text-transform:uppercase;">First Communion</a></li><li style="display:none;" class="dropdown-submenu"><a href="Floral_Supplies" style="text-transform:uppercase;">Floral Supplies</a></li><li style="display:none;" class="dropdown-submenu"><a href="Gifts_Favors" style="text-transform:uppercase;">Gifts &amp; Favors</a></li><li style="display:none;" class="dropdown-submenu"><a href="Glassware" style="text-transform:uppercase;">Glassware &amp; Vases</a></li><li style="display:none;" class="dropdown-submenu"><a href="Graduation" style="text-transform:uppercase;">Graduation</a></li><li style="display:none;" class="dropdown-submenu"><a href="Holiday_Seasonal" style="text-transform:uppercase;">Holiday &amp; Seasonal</a></li><li style="display:none;" class="dropdown-submenu"><a href="Home_Decor" style="text-transform:uppercase;">Home Decor</a></li><li style="display:none;" class="dropdown-submenu"><a href="Jewelry" style="text-transform:uppercase;">Jewelry</a></li><li style="display:none;" class="dropdown-submenu"><a href="Mardi_Gras" style="text-transform:uppercase;">Mardi Gras</a></li><li style="display:none;" class="dropdown-submenu"><a href="Mi_Presentacion_De_3_Anos" style="text-transform:uppercase;">Mi Presentacion De 3 Años</a></li><li style="display:none;" class="dropdown-submenu"><a href="Party_Supplies" style="text-transform:uppercase;">Party Supplies</a></li><li style="display:none;" class="dropdown-submenu"><a href="Quinceanera" style="text-transform:uppercase;">Quinceañera</a></li><li style="display:none;" class="dropdown-submenu"><a href="Religious" style="text-transform:uppercase;">Religious</a></li><li style="display:none;" class="dropdown-submenu"><a href="Ribbon_Trimming" style="text-transform:uppercase;">Ribbon &amp; Trimming</a></li><li style="display:none;" class="dropdown-submenu"><a href="Wedding" style="text-transform:uppercase;">Wedding</a></li></ul><p style="margin-top: 204px;"></p>									<div class="left-link-container" style="margin: 0 0 28px 10px !important;">
...
<!-- IMAGE PICKER -->
            <div class="religious_container" style="display:none;">
                ...
                <div class="ps-scrollbar-x-rail" style="width: 190px; display: none; left: 0px; bottom: 3px;"><div class="ps-scrollbar-x" style="left: 0px; width: 0px;"></div></div><div class="ps-scrollbar-y-rail" style="top: 0px; height: 385px; display: none; right: 3px;"><div class="ps-scrollbar-y" style="top: 0px; height: 0px;"></div></div></div>
            </div>
        ...
        <div id="panel-right" class="">
            ...
            <div id="panel-right-level-one-menu" class="panel-row" style="margin-top:5px; margin-bottom:5px;">
                ...
                <div id="panel-right-menu-container" class="float-left noprint">
                    <!-- menu -->
                    <ul class="top-menu"><li><a href="index.php">HOME</a></li><li><a href="https://www.portofinointl.com/about_us">ABOUT US</a></li><li><a href="quick_order.php" id="quick-order-soon-txt">QUICK ORDER</a></li><li><a href="signup.php" id="login-user">LOG IN / REGISTER</a></li><li style="padding-right: 0;"><a href="shopcart.php" id="login-user">VIEW CART</a></li></ul>                        <!-- end.menu -->
                </div>
...
<table class="login-register-form-table" border="0" style="margin-top:0; width:50%;">
<tbody><tr>
...
New Customer? Click <a href="signup.php?sec=reg" style="color:#FF0000; font-weight:bold;">HERE</a><br>
        ...
        <div style="margin-top:50px;" class="noprint"><a href="content.php?pgID=31#priceguaranteepolicy"><img src="images/blrb20160202110641web_banner_r.png" border="0" width="717" height="110"></a></div><div class="clearfix">&nbsp;</div>			
        <!-- END.container -->
    </div>
    ...
    <div class="container ">
        ...
        <div id="footer-container-security-logos" class="panel-row noprint" style="margin-bottom:64px; margin-top:-10px;margin-left:205px; width:720px;">
               <p><a href="#"><img src="/images/elavon-logo.jpg" style="height:33px; width:70px"> </a><img src="/images/security-logo-cc.png" style="height:20px; width:140px">&nbsp;&nbsp;&nbsp;<span id="siteseal"><script type="text/javascript" src="https://seal.godaddy.com/getSeal?sealID=3Nw1CjH2BzKbhrXWuAiDEWwJkqjxdI8SNpJpHVmTSsC0usbVOrK02lkc8r"></script><img style="cursor:pointer;cursor:hand" src="https://seal.godaddy.com/images/3/en/siteseal_gd_3_h_l_m.gif" onclick="verifySeal();" alt="SSL site seal - click to verify"></span>
<br>
Copyright © 2024 Portofino International Trading USA, Inc. All rights reserved.</p>
