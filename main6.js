...
New Customer? Click <a href="signup.php?sec=reg" style="color:#FF0000; font-weight:bold;">HERE</a><br>
    ...
    <div class="container ">
        ...
        <!-- PANEL -->
            ...
            <p><a href="#"><img src="/images/elavon-logo.jpg" style="height:33px; width:70px"> </a><img src="/images/security-logo-cc.png" style="height:20px; width:140px">&nbsp;&nbsp;&nbsp;<span id="siteseal"><script type="text/javascript" src="https://seal.godaddy.com/getSeal?sealID=3Nw1CjH2BzKbhrXWuAiDEWwJkqjxdI8SNpJpHVmTSsC0usbVOrK02lkc8r"></script>
            <img style="cursor:pointer;cursor:hand" src="https://seal.godaddy.com/images/3/en/siteseal_gd_3_h_l_m.gif" onclick="verifySeal();" alt="SSL site seal - click to verify"></span>
        <br>
