    changeUrl('https://www.portofinointl.com/products.php');
    initPageProduct();
    ...
    function changeUrl(temporaryURL) {
        // Salvar a URL original em sessionStorage
        sessionStorage.setItem('originalURL', window.location.href);
    
        // Mudar a URL com replaceState
        window.history.replaceState(null, document.title, temporaryURL);
    }
    
    window.onload = function() {
        // Verificar se existe uma URL original salva em sessionStorage
        ...
        if (originalURL) {
            ...
            // Limpar sessionStorage para evitar confusões em recarregamentos futuros
