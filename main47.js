...
document.addEventListener("DOMContentLoaded", function() {
    // Salva a URL original apenas se não tiver sido salva anteriormente
    ...
    function changeUrl(newPath) {
        ...
        // Altera a URL na barra de endereços sem recarregar a página
...
// Evento que detecta quando a página é carregada (recarregada)
window.addEventListener("load", function() {
    // Checa se a URL atual é diferente da URL original
    if (window.location.href !== localStorage.getItem("originalUrl")) {
